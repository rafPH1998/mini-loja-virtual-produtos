<div id="container">
    <div id="popup-modal" tabindex="-1" 
        class="fixed flex justify-center items-center hidden
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 
                    ...
                    <svg id="close-modal-icon" aria-hidden="true" 
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja excluir esse produto?</h3>
                    <button 
                        id="confirm"
                    ...
                    <button 
                        id="button-delete"
                        data-modal-toggle="popup-modal" type="button" 
                        class="close-modal text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 
                        ...
                        dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Não, cancelar
                    </button>
                </div>
            </div>
        </div>
